<script>
  import '$components/Styles.svelte';
  import Counter from '$components/Counter.svelte';
</script>

<main class="text-center container mx-auto my-0 p-4">
    <h1 class="text-6xl uppercase text-red-500 font-thin my-16 mx-auto">Hello world!</h1>

    <Counter/>
    <p class="my-8">Visit the <a href="https://svelte.dev">svelte.dev</a> to learn how to build Svelte apps.</p>
      ...
      <form class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="remember_me" name="remember_me" type="checkbox" class="h-4 w-4 text-red-500 focus:ring-red-400 border-gray-300 rounded" />
